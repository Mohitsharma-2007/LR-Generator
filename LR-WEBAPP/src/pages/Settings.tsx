...
export default function Settings() {
  ...
  const [partnerName, setPartnerName] = useState(
    settings.partnerName || "NISSIN ABC LOGISTICS PVT. LTD.",
  );
  const [partnerAddress, setPartnerAddress] = useState(
    settings.partnerAddress || "",
  );
    ...
    reader.onload = async (event) => {
      try {
        ...
        const importedSettings = {
          ...
          partnerName:
            backup.settings?.partnerName || "NISSIN ABC LOGISTICS PVT. LTD.",
          partnerDetails,
          partnerAddress,
          partnerGst,
        };
        ...
        alert(
          "Import failed. Make sure the file is a valid .lrbackup JSON: " +
            String(err),
        );
      }
    };
  ...
  return (
    ...
    >
      ...
      >
        <h3 style={{ fontSize: "15px", fontWeight: 700, color: "var(--gold)" }}>
          Security & Access
        </h3>
      ...
      >
        ...
        >
          Export all Lorry Receipts and configuration parameters locally as a
          `.lrbackup` backup file, or restore them.
        </span>
        <div style={{ display: "flex", gap: "10px" }}>
          <button
      ...
      {showPinModal && (
        <div className="modal-overlay">
          <div
            ...
            style={{ maxWidth: "340px", padding: "20px" }}
          >
            <div
              style={{
                display: "flex",
