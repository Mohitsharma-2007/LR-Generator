...
export function generateLRHtml(lr: LRRecord): string {
...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .section { display: flex; margin-bottom: 8px; }
  .half { width: 50%; }
  .label { font-weight: bold; font-size: 9px; }
  .value { font-size: 9px; line-height: 1.5; }
  .consignee-box { border: 1px solid #000; padding: 6px; }
  ...
  .bank-section { margin-top: 8px; border: 1px solid #000; padding: 8px; }
...
<body>
  ...
  <div class="main-row">
    <div class="left-col">
      <div class="label" style="font-size:10px; margin-bottom:4px;">NISSIN ABC LOGISTICS PVT. LTD.</div>
      <div class="value">Unit No. 222, 244, 246 &amp; 247, 2nd Floor,<br>Centrum Plaza, Golf Course Road, Sector - 53,<br>Gurugram - 122 002, Haryana,<br>GSTIN: 06AABCN0379D1ZS</div>
    </div>
    <div class="right-col">
  ...
  <div style="display:flex; justify-content:flex-end; margin-top:8px;">
    <div class="bank-section" style="width:60%;">
